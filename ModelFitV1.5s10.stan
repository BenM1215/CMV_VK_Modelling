...
transformed parameters {
      ...
      for (subject in 1:nSubjects) {
        ...
        ind_theta[1] = beta * exp(eta_beta[subject]);
        ind_theta[2] = lambda * exp(eta_lambda[subject]);
        ind_theta[3] = delta * exp(eta_delta[subject]);
        ind_theta[4] = rho * exp(eta_rho[subject]);
        //ind_theta[5] = c * exp(eta_c[subject]); //Forces model instability
        ind_theta[5] = c;
        ...
        yhat = 
          ...
          time[position:position+s[subject]-1], ind_theta, 
          x_r, x_i);
...
//        ind_theta[3] = delta * exp(eta_delta[subject]);
//        ind_theta[4] = rho * exp(eta_rho[subject]);
//        //ind_theta[5] = c * exp(eta_c[subject]);
//        ind_theta[5] = c;
//        
//        yhat_pop =
//          integrate_ode_rk45(ode, Y0, t0, 
