...
for (i in 1:numPatients){
  ...
  parameters[1] <- parameters[1] + rnorm(1, 0, 0.1)
  parameters[2] <- parameters[2] + rnorm(1, 0, 0.1)
  parameters[3] <- parameters[3] + rnorm(1, 0, 0.1)
  parameters[4] <- parameters[4] + rnorm(1, 0, 0.1)
  parameters[5] <- parameters[5] + rnorm(1, 0, 0.1)
  
  V0 <- runif(1, min = 1000, max = 1100)
  
  state <- c(U=100, I=0, V=V0)
  
  #times <- 1:100
  times <- 1:runif(1, min = 90, max = 110)
...
write.csv(out, 'SimulatedData.csv')
```
